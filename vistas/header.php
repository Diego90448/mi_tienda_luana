...
<head>
  ...
  <title>LUANAboutique | Escritorio</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-lg"><b>LUANA</b> BOUTIQUE</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Diego Gimenez-Desarrollo de software
...
if ($_SESSION['consultav']==1) {
  echo '<li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="ventasfechaarticulo.php"><i class="fa fa-circle-o"></i> Consulta Articulos</a></li>
          </ul>
        </li>';
}
        ?>     
